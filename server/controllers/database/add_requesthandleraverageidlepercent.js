...
const add_requesthandleraverageidlepercent = async (lastTimeStamp) => {
  try {
    const res = await fetch(`${BASE_PATH}${PROM_QUERY}kafka_server_request_handler_avg_idle_percent[5m]`);
    ...
    console.log('ERROR: add_requesthandleraverageidlepercent', err);
  }
};

module.exports = add_requesthandleraverageidlepercent