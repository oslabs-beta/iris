...
const add_requesthandleraverageidlepercent = (lastTimeStamp) => {
    ...
    .then(data => {
      ...
      if (body[body.length - 2] === ')') {
        db.query(body, (err, res) => {
          if (err) console.log('ERROR: dbController.add_requesthandleraverageidlepercent cannot overwrite data')
        })
      }
      else {
