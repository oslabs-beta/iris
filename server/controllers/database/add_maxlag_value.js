...
const add_maxlag_value = async (lastTimeStamp) => {
  try {
    const res = await fetch(`${BASE_PATH}${PROM_QUERY}kafka_server_replica_fetcher_manager_maxlag_value[5m]`);
    ...
    console.log('ERROR: add_maxlag_value', err);
  }
};
