...
const add_underreplicatedpartitions = async (lastTimeStamp) => {
  try {
    const res = await fetch(`${BASE_PATH}${PROM_QUERY}kafka_server_replica_manager_underreplicatedpartitions[5m]`);
    ...
    console.log('ERROR: add_underreplicatedpartitions', err);
  }
};

module.exports = add_underreplicatedpartitions