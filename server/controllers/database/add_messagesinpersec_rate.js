...
const add_messagesinpersec_rate = async (lastTimeStamp) => {
  try {
    const res = await fetch(`${BASE_PATH}${PROM_QUERY}kafka_server_broker_topic_metrics_messagesinpersec_rate[5m]`);
    ...
    console.log('ERROR: add_messagesinpersec_rate', err);
  }
};
