...
const add_offlinereplicacount = async (lastTimeStamp) => {
  try {
    const res = await fetch(`${BASE_PATH}${PROM_QUERY}kafka_server_replica_manager_offlinereplicacount[5m]`);
    ...
    console.log('ERROR: add_offlinereplicacount', err);
  }
};

module.exports = add_offlinereplicacount