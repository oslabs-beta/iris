...
const add_scrapedurationseconds = async (lastTimeStamp) => {
  try {
    const res = await fetch(`${BASE_PATH}${PROM_QUERY}scrape_duration_seconds[5m]`);
    ...
    console.log('ERROR: add_scrapedurationseconds', err);
  }
};
